...
export default function Home() {
  return (
    <div className="bg-background relative min-h-screen overflow-x-clip print:hidden">
      <div className="from-primary/12 via-background/90 to-background pointer-events-none absolute inset-x-0 top-0 -z-10 h-96 bg-gradient-to-b" />
      <SiteHeader />
          ...
          <div className="site-container space-y-8 text-center">
            ...
            <div className="flex justify-center">
              <Badge variant="secondary" className="gap-1.5 px-3 py-1 text-sm">
                <FileText className="size-3.5" aria-hidden="true" />웹 기반
                견적서 서비스
              </Badge>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-muted-foreground mx-auto max-w-xl text-base sm:text-lg">
                전달받은 링크 하나로 견적서를 웹 브라우저에서 바로 열람하고,
                PDF로 저장하거나 인쇄할 수 있습니다.
              </p>
            </div>
              ...
              {features.map(feature => {
                ...
                return (
                  <Card
                    key={feature.title}
                    role="listitem"
                    className="border-border/70 bg-card/80 h-full transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md"
                  >
                    <CardHeader>
                      {/* 기능 아이콘 */}
                      <div
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
              {steps.map((item, index) => {
                ...
                return (
                  ...
                  >
                    {/* 단계 번호와 아이콘 */}
                    <div className="bg-primary text-primary-foreground relative flex size-16 items-center justify-center rounded-full shadow-sm">
      ...
      {/* ── 푸터 ── */}
      <footer role="contentinfo" className="border-border/60 border-t">
        <div className="site-container py-8 text-center">
          <p className="text-muted-foreground text-sm">
            &copy; {new Date().getFullYear()} 견적서 웹 뷰어. All rights
            reserved.
          </p>
        </div>
      </footer>
